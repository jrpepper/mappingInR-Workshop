...
Below is the raw code for the workshop: 'Mapping in Leaflet'. I recommend using the [Markdown text](mapping-in-r.html), as it has all of the maps printed out as figures, but just having blocks of the code may be more useful if you want to highlight and run through all the code at once.
